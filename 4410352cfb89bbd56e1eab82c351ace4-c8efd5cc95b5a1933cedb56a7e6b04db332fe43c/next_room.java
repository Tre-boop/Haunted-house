public static void next_room(){
    ...
    while (true) {
        System.out.println("You proceed to throught the first door and arrive in what seems to be your grandpa's study.");
        System.out.println("as you search around for clues you notice two book perturding from the bookcase.");
        ...
        System.out.println("The door on the left has a spider orndement for a door knob. The second door has what seems like slime trickling down from the top.\n which door will you pick 1 or 2?");
// try and figure out how to link the rooms. switch (rooms)
        // case 2.1:
        //next_room2.1();
        // case 2.2:
        //next_room2.2();
